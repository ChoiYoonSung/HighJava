...
public class MySingleton {
	...
	public static MySingleton getInstance() {
		if(single == null) {
			single = new MySingleton(); //singleton이 없을 때 생성
		}	
		return single;
	}
	...
	public void displayText() {
		System.out.println("Hello, World! This is Singleton Instance");
	}
