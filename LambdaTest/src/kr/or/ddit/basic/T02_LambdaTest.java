...
public class T02_LambdaTest {
	public static void main(String[] args) {
		...
		LambdaTestintergace2 lam5 =
			z -> System.out.println("result = " + (z+500));
		lam5.test(90);
		
		System.out.println("---------------------------------");
		
		LambdaTestintergace3 lam6 =
			(int x, int y) -> {
				int r = x + y;
				return r;
			};
		...
		LambdaTestintergace3 lam8 =
			(x, y) ->  x + y;
		k = lam8.test(100, 200);
		System.out.println("k = " + k);
		
		LambdaTestintergace3 lam9 =
			(x, y) ->  {return x > y ? x : y;};
		k = lam9.test(100, 200);
		System.out.println("k = " + k);
