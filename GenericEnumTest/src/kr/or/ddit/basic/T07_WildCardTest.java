...
public class T07_WildCardTest {
	/**
	 	모든 과정 수강정보 조회
	 */
//	public static <T> void listCourseInfo(Course<T> course) { //제너릭 형태
	public static void listCourseInfo(Course<? /*extends Person*/> course) {
...
class Course<T>{
	...
	public void add(T t) {
		for (int i = 0; i < students.length; i++) {
			if(students[i]==null) { //등록되지 않은 자리인지 확인
				students[i] = t;
				break;
			}
