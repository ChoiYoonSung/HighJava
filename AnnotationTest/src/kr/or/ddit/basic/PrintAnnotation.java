...
/*
	...
	종류 : 1. 표준 Annotation(주로 컴파일러에게 유용한 정보를 제공하기 위한 Annotation)
		 2. 메타 Annotation(Annotation을 위한 Annotation, 즉 Annotation을 정의할 때 사용하는
		 					Annotation)
	Annotation 타입 정의하기
 ...
 */
@Target(ElementType.METHOD)	// annotation이 적용가능 한 대상을 지정함
@Retention(RetentionPolicy.RUNTIME)	// 유지되는 기간(SOURCE, CLASS(default), RUNTIME)
